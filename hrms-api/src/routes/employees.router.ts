...
import { branches, orgHierarchyDepartments as departments, orgHierarchyDesignations as designations, employees, orgHierarchyStructure, roles } from "@/db/schema/hrms";
